...
export function SocialShare({ url, title, description, className = '', articleId }: SocialShareProps) {
  ...
  const handleShare = (platform: keyof typeof shareLinks) => {
    ...
    if (articleId) {
      trackSocialShare(platform, articleId, title);
    }
  };
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <button
        ...
        className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-400 hover:bg-blue-500 text-white transition-colors"
      ...
      <button
        ...
        className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 hover:bg-orange-600 text-white transition-colors"
